  ...
  return (
    <>
      <div className="z-10  mx-auto ">
        <div className=" lg:py-8 sm:py-5 py-4 bg-white dark:bg-slate-800/70">
          <div className="conatiner-page flex justify-around md:text-3xl sm:text-2xl text-xl ">
            <div>
        ...
        <div className="bg-sub-img">
          <div className="grid md:grid-cols-2 grid-cols-1 max-w-[1450px] px-[10px] mx-auto gap-x-10 py-3">
            <div className="py-6">
              <h3 className="text-white md:text-sm text-xs text-center mb-7">
              ...
              <div className="  items-center  flex space-y-0">
                <div className="relative w-full">
                  ...
                  <input
                    className="focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full  bg-gray-50 p-3 pl-4 text-sm text-gray-700 rounded-none rounded-l-full"
                ...
                <div>
                  <button
                    type="submit"
                    className="bg-primary  w-full cursor-pointer px-5 py-3 text-center text-sm font-medium text-white  rounded-none rounded-r-full"
                  >
                    Subscribe
                  </button>
                </div>
        ...
        <footer className="bg-gray dark:bg-slate-800/70">
            ...
            <div className="md:flex md:justify-between ">
              <div className="mb-6 md:mb-0 space-y-5 block  justify-between md:justify-normal mr-5 ">
                <div>
                  ...
                  >
                    <Image
                      src="https://www.lifepharmacy.com/images/logo.svg"
                      className="h-10 mr-3"
                      alt="FlowBite Logo"
                      width={250}
                      height={250}
              ...
              <div className="grid sm:grid-cols-2 grid-cols-1 gap-8 sm:gap-6 lg:grid-cols-5 text-xs md:text-sm md:grid-cols-3 ">
                <div>
                <Typography size={"sm"} bold={"bold"} className="mb-3">
      ...
      <div className="max-w-[1450px] px-[10px] mx-auto">
        <div className="flex justify-between py-8 border-b border-muted">
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="md:text-base text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © 2023{" "}
          ...
          <>
            <section>
              ...
              <p>
                ...
                healthcare retail. Starting with one store, Life Pharmacy in UAE
                has 300+ retail outlets consisting of Pharmacies, Healthcare
                Hypermarkets, Health and Wellness stores catering to an average
                annual customer base of more than ten million walk-ins. Life
                Pharmacy is also the number one Online pharmacy in UAE. Life
                Pharmacy app and website are widely used by users across UAE for
                all their health, fitness & lifestyle needs.
              </p>
            </section>
            <section className="ol-footer">
              ...
              <ul>
                <li>
                  <p>
                    Our Heritage: Life Pharmacy started its journey in 1996 with
                    a strong impulse to provide state-of-the-art experience in
                    ...
                    walk-ins. Life Pharmacy is also the number one Online
                    pharmacy in UAE. Life Pharmacy app and website are widely
                    used by users across UAE for all their health, fitness &
                    lifestyle needs.
                  </p>
                </li>
                <li>
                  <p>
                    ...
                    Life Pharmacy has been named as the largest pharmacy network
                    in UAE. The healthcare group aims to expand the number of
                    outlets and increasing presence to five times the current
                    store count in the coming 4 years and increase the current
                    store count to 1500 by end of 2025.
                  </p>
                </li>
                <li>
                  <p>
