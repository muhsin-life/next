...
const iconVariants = cva("block", {
  variants: {
    variant: {
      default: "",
      inputIconRight: "absolute right-2 inset-y-0  ml-2 flex my-auto ",
      inputLoadingIcon:
        "absolute right-2 inset-y-0  ml-2 flex my-auto pointer-events-none animate-spin",
      inputIconLeft:
        "absolute left-2 inset-y-0  pl-2 my-auto pointer-events-none",
      loading:
...
const Icon: React.FC<IconProps> = ({
  ...
  return (
    <Icons
      ...
      {...props}
      className={cn(
        iconVariants({ size, className, variant }),
...
const Icons: React.FC<IconProps> = ({ type, iconIsLoading, ...props }) => {
  switch (type) {
    case "crossIcon":
      return (
        <svg
    ...
    case "ordersIcon":
      return (
        <svg
          ...
          {...props}
          fill="currentColor"
          className="h-6 w-6  transition duration-75 group-hover:text-gray-900 group-hover/dashbtn:fill-blue-500"
          viewBox="0 0 16 16"
        >
    ...
    case "chevronBottomIcon":
      return (
        <svg
          ...
          {...props}
          stroke="currentColor"
          className="h-6 float-right  w-4 mr-2 group-hover:-rotate-180 transition-transform duration-200"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
