...
export const SingleProductData = ({
  ...
  return (
    <>
      {pro_data && !isRowView ? (
        <div className="border border-muted rounded-lg bg-white max-w-[250px] dark:bg-slate-900/70">
            ...
            >
              ...
              {loadingState ? (
                <div className="bg-white/50 absolute inset-0 flex justify-center items-center">
                  <Icon type="refreshIcon" className="animate-spin text-slate-500" size={"lg"} />
                </div>
              ) : null}
