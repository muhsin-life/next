      ...
      <div className="space-y-4 md:col-span-4 col-span-full">
        <div className="rounded-lg space-y-1">
          ...
          <Input
            ...
            type="text"
            buttonRight={<Button className="rounded-l-none">Apply</Button>}
          />
        </div>
          ...
          {newCardSelected ? (
            <div className="flex justify-between items-center">
              ...
              <u
                ...
                className="text-blue-500 flex space-x-1 p-2 items-center cursor-pointer"
              >
                <small>CHANGE</small>
            ...
            >
              ...
              <Icon type="chevronBottomIcon" size={"xs"} />
            </u>
          )}
        </div>
